...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260505171908_EmployeeMachinePermissions")]
    partial class EmployeeMachinePermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Assets.AssetUsageReading", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "AssetId", "MeterType", "RecordedAtUtc");

                    b.ToTable("asset_usage_readings", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Employees.EmployeeSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Lean.ImprovementIdea", b =>
                {
                    ...
                    b.Property<string>("BaselineMetricName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<decimal?>("ImplementedSavingsPerMonth")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)");
            ...
            modelBuilder.Entity("Domain.Maintenance.FailureCauseCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("failure_cause_categories", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Maintenance.FailureReport", b =>
                {
                    ...
                    b.Property<Guid?>("FailureCauseCategoryId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("ProductionLossUnits")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.HasIndex("FailureCauseCategoryId");
            ...
            modelBuilder.Entity("Domain.Maintenance.MaintenanceExecution", b =>
                {
                    ...
                    b.Property<decimal?>("ScheduledMeterValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Domain.Maintenance.MaintenancePlan", b =>
                {
                    ...
                    b.Property<decimal?>("AutoCreateLeadMeterValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal?>("NextDueMeterValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.HasIndex("TenantId", "AssetId", "NextDueMeterValue");
            ...
            modelBuilder.Entity("Domain.Maintenance.WorkOrder", b =>
                {
                    ...
                    b.Property<DateTime?>("PlannedForOccurrenceUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<decimal?>("TriggeredByMeterValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Domain.Assets.AssetUsageReading", b =>
                {
                    ...
                    b.HasOne("Domain.Employees.EmployeeProfile", "RecordedByEmployee")
                        .WithMany("RecordedAssetUsageReadings")
                        .HasForeignKey("RecordedByEmployeeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Domain.Instance.Tenant", "Tenant")
                        .WithMany("AssetUsageReadings")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Employees.EmployeeSkill", b =>
                {
                    ...
                    b.HasOne("Domain.Instance.Tenant", null)
                        .WithMany("EmployeeSkills")
                        .HasForeignKey("TenantId");
            ...
            modelBuilder.Entity("Domain.Maintenance.FailureCauseCategory", b =>
                {
                    b.HasOne("Domain.Instance.Tenant", "Tenant")
                        .WithMany("FailureCauseCategories")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Maintenance.FailureReport", b =>
                {
                    ...
                    b.HasOne("Domain.Maintenance.FailureCauseCategory", "FailureCauseCategory")
                        .WithMany("FailureReports")
                        .HasForeignKey("FailureCauseCategoryId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("FailureCauseCategory");
            ...
            modelBuilder.Entity("Domain.Employees.EmployeeProfile", b =>
                {
                    ...
                    b.Navigation("RecordedAssetUsageReadings");
            ...
            modelBuilder.Entity("Domain.Instance.Tenant", b =>
                {
                    ...
                    b.Navigation("AssetUsageReadings");
                    ...
                    b.Navigation("FailureCauseCategories");
