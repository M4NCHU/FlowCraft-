...
import { HallsFilters, type HallsSortKey, type SortDir } from "./components/HallsFilters";
            ...
            {filtered.map((hall) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                      ...
                      <span className="rounded-full border border-slate-200 bg-slate-50 px-2 py-0.5">
                        Sekcje: <span className="text-slate-700">{hall.sectionsCount}</span>
                      </span>
                    </div>
                  </div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Link
                    to={`/halls/${hall.id}`}
                    className="rounded-md border border-slate-200 px-3 py-2 text-xs font-medium text-slate-800 hover:bg-slate-50"
                  >
                    Szczegóły
                  </Link>
                  <Link
